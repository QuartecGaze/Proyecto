<?php
    ...
    Class ServicioCooperativa {
        ...
        public function subirComprobante($nombreArchivo, $nombreTemp, $idComprobante, $motivo){ //traer el idcomprobante y motivo del front
                session_start();
                ...
                if (count($archivoExiste) > 0) {
                   ...
                   if(move_uploaded_file($nombreTemp, $nuevaRuta)){
                    $this->repositorio->subirComprobante($nuevoNombre, $idComprobante, $motivo);
                    return(true);
                } else{
