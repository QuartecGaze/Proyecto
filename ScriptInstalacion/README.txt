Para poder ejecutar correctamente la instalacion del software se debe:
UTILIZAR ROCKY LINUX 8.10
1. Ejecutar el primer script directamente en el sistema o maquina virtual (instalador_parte1.sh)
