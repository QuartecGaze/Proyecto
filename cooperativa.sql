...
-- Tiempo de generación: 30-09-2025 a las 23:25:00
...
(3, NULL, 'En espera', 'En espera', NULL, NULL, NULL, 'En espera', NULL, 0);
...
(1, '11111111', 'josemuniz@gmail.com', '$2y$10$aBlyDLXBDgtozyc/s9vqJOXBY.EErwgXYIvB3jhxGkRvItHvwsvRO', 'Admin', 'Jose', 'Muniz Lopes'),
(3, '12312312', 'esthercopos@gmail.com', '$2y$10$3SfHbGmN3rYZk6jHgjv2C.Zn5U.6s.1HMqxKPpW55DouYOJul7XAa', 'Usuario', 'Esther', 'Maria Copos');
...
('8e34ab82dd7cdecd8f091f2d9ca7976a0512350fb9e21de42b0a18fe57d8b701', 1, '2025-09-30', '2025-10-01'),
('71b7cf4e2ff1d16d6ec1bed150d7d09d3a2fa9e639cf881a4ed9dcabe9771a68', 2, '2025-09-30', '2025-10-01');
...
--
ALTER TABLE `comprobante_pago`
  MODIFY `ID_Comprobante_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
